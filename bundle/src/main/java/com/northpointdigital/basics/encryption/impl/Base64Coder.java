...
public class Base64Coder {
 ...
 /**
  * Encodes a byte array into Base64 format. No blanks or line breaks are inserted in the
  * output.
  * 
  * @param in
  *            An array containing the data bytes to be encoded.
 ...
 /**
  * Decodes a byte array from Base64 format and ignores line separators, tabs and blanks. CR,
  * LF, Tab and Space characters are ignored in the input data. This method is compatible with
