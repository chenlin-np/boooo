...
if(theseDamDocuments.isEmpty()){
    String siteName = getSiteName(currentPage);
    if(siteName!=null){
		theseDamDocuments = "/content/dam/" +  siteName + "/documents";
    }
...
mapFullText.put("group.5_fulltext.relPath", "jcr:content/@cq:name");
